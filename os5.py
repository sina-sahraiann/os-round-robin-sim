    ...
    def run(self):
        while self.current_cpu_index < len(self.cpu_times):
            ...
            if self.response_time is None:
                self.response_time = ((self.currently_waiting - self.arrival_time) // 1)
